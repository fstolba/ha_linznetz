...
from .const import (
    ...
    CONF_PASSWORD,
    CONF_USERNAME,
    DOMAIN, CONF_WEBHOOK_ID, CONF_WEBHOOK_URL
)
...
class LinzNetzFlowHandler(config_entries.ConfigFlow, domain=DOMAIN):
    ...
    async def async_step_user(self, user_input=None):
        ...
        if not errors and valid:
            meter_partial = user_input[CONF_METER_POINT_NUMBER][2:10]
            user_input[CONF_WEBHOOK_ID] = f"linznetz{meter_partial}"
            user_input[CONF_WEBHOOK_URL] = ""
